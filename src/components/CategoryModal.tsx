...
export function CategoryModal({ isOpen, onClose, onSave, editingCategory, userId }: CategoryModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm z-[60] flex justify-center items-end sm:items-center p-4">
      <div 
        className="bg-slate-900 border border-slate-700/50 w-full max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 animate-in slide-in-from-bottom-4 sm:slide-in-from-bottom-0 sm:fade-in duration-300 max-h-[90vh] overflow-y-auto"
